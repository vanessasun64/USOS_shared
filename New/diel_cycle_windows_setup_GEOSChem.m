...
%%
    ...
    %   names       %values
        ...
        %if the J is lower case, then in F0AM_ModelCore.m the 
        %Met = CheckStructure(Met,FieldInfo,'J');
        %needs to have lowercase J as string for mechanism

        %example: 'J3' USOS.jBr2*0.3 (jcorr)
        'jO31D'        USOS.jO3 .* USOS.jNO2_ratio; %  O3 -> O1D
        'jNO2'        USOS.jNO2 .* USOS.jNO2_ratio;
        'jNO3_b'     USOS.jNO3a .* USOS.jNO2_ratio;
        'jNO3_a'    USOS.jNO3b .* USOS.jNO2_ratio;
        'jHNO2'       USOS.jHNO2 .* USOS.jNO2_ratio;
        'jHNO3'       USOS.jHNO3 .* USOS.jNO2_ratio;
        'jH2COa'     USOS.jCH2Oa .* USOS.jNO2_ratio;
        'jH2COb'     USOS.jCH2Ob .* USOS.jNO2_ratio;
        ...
        'jCCl4'       USOS.jCCl4 .* USOS.jNO2_ratio;
        };
    ...
    InitConc = {...
        ...
        'MTPA'              USOS.Monoterpenes_PTR   hold;
        ...
        'TOLU'               USOS.Toluene_PTR        hold;
        'STYR'              USOS.Styrene_PTR        hold;
        'NAP'               USOS.Naphthalene_PTR    hold;
    
        %Oxygenates
        'MOH'              USOS.Methanol_PTR       hold;
        'ALD2'              USOS.Acetaldehyde_PTR   hold;
        'EOH'              USOS.Ethanol_PTR        hold;
        'CH2O'              USOS.HCHO_CRDS          hold; %Formaldehyde 
        'HCOOH'              USOS.HCOOH_CIMS         hold; %Formic Acid
        'ACR'               USOS.Acrolein_PTR       hold;
    ...
    %}
    ChemFiles = {...
       'GEOSCHEM_K_v1452_Hg(Met)'; %contains all k-rates
       'GEOSCHEM_J_v1452_Hg(Met,2)'; %photolysis file, flag of 2 means we're using the Hybrid Method
       'GEOSCHEM_GasRxns_v1452_Hg'; %Lists all reactions and species to add
       };
