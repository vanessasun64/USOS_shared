...
dir_path = strcat(savedir,runname_str,'/','Run13/');
mkdir(dir_path);
...
for spn=0:1
    ...
    %   names       %values
        ...
        'kdil'       1/(20*60*60); %dilution constant, /s
        'jcorr'      0.4; %optimizes comparison b/w model and observed NO/NO2
        };
    ...
    InitConc = {...
        ...
        'HNO3'              USOS.HNO3_CIMS          hold;%evolve?
        %'PAN'               USOS.PAN_CIMS           1;
        ...
        'FORM'              USOS.HCHO_CRDS          hold; %Formaldehyde %evolve?
