...
o = ones(size(SOAS.T));
time_SOAS.year           = 2013*o;
time_SOAS.month          = 6*o;
time_SOAS.day            = 30*o;
time_SOAS.hour           = SOAS.Time;
time_SOAS.min            = 0*o;
time_SOAS.sec            = 0*o;
time_SOAS.UTC            = -5;
location_SOAS.latitude   = 32.903;
location_SOAS.longitude  = -87.250;
location_SOAS.altitude   = 126;
sun_SOAS = sun_position(time_SOAS,location_SOAS); %fields zenith and azimuth
...
%   names       %values
    ...
    'SZA'        sun_SOAS.zenith; %solar zenith angle, degrees
...
ModelOptions_SOAS.Verbose        = 2;
ModelOptions_SOAS.EndPointsOnly  = 1;
ModelOptions_SOAS.LinkSteps      = 1;
ModelOptions_SOAS.IntTime        = 3600; %3600 seconds/hour
ModelOptions_SOAS.TimeStamp      = SOAS.Time;
ModelOptions_SOAS.SavePath       = 'DielExampleOutput';
...
[Met_SOAS,InitConc_SOAS,BkgdConc_SOAS,repIndex] = InputReplicate(Met_SOAS,InitConc_SOAS,BkgdConc_SOAS,nRep);
ModelOptions_SOAS.TimeStamp = repmat(ModelOptions_SOAS.TimeStamp,nRep,1);
...
S = F0AM_ModelCore(Met_SOAS,InitConc_SOAS,ChemFiles_SOAS,BkgdConc_SOAS,ModelOptions_SOAS);
