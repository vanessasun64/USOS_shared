...
%128
i=i+1;
Rnames{i} = 'KET = 0.5ALD2 + 0.5C2O3 + 0.5XO2H + 0.5CXO3 + 0.5MEO2 + RO2 + 2.5PAR'; %minus PAR
k(:,i) = JMEK;
Gstr{i,1} = 'KET';
...
%132
i=i+1;
Rnames{i} = 'OH + PAR = 0.11ALDX + 0.76ROR + 0.13XO2N + 0.11XO2H + 0.76XO2 + RO2 + 0.11PAR'; %minus PAR
k(:,i) = 8.1e-13;
...
%133
i=i+1;
Rnames{i} = 'ROR = 0.2KET + 0.42ACET + 0.74ALD2 + 0.37ALDX + 0.04XO2N + 0.94XO2H + 0.98RO2 + 0.02ROR + 2.7PAR';  %minus PAR
...
%142
i=i+1;
Rnames{i} = 'OH + OLE = 0.781FORM + 0.488ALD2 + 0.488ALDX + 0.976XO2H + 0.195XO2 + 0.024XO2N + 1.195RO2 + 0.73PAR'; %minus 0.73 PAR
k(:,i) = K_OH_OLE;
...
%143
i=i+1;
Rnames{i} = 'O3 + OLE = 0.295ALD2 + 0.555FORM + 0.27ALDX + 0.15XO2H + 0.15RO2 + 0.334OH + 0.08HO2 + 0.378CO + 0.075GLY + 0.075MGLY + 0.09FACD + 0.13AACD + 0.04H2O2 + 0.79PAR'; %minus PAR
...
%144
i=i+1;
Rnames{i} = 'NO3 + OLE = 0.5NO2 + 0.5NTR1 + 0.48XO2  + 0.48XO2H + 0.04XO2N + RO2 + 0.5FORM + 0.25ALD2 + 0.375ALDX + PAR';  %minus PAR
