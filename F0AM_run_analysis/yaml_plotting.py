...
four_colorset1 = rgb_range_correction([forest_green_color, turquoise_color, bright_orange_color, desaturated_pink_color])
...
def plot_ozone_hourly_median():
    ...
    plt.plot(hour_range, df_CB6r5h_hourly_medians_species_conc['O3Initconc'], label = 'Obs.', linestyle = 'solid', linewidth = 2, color = 'black')
    obs_percentile_25_ozone=df_CB6r5h_hourly_medians_species_conc.groupby('hour')['O3Initconc'].apply(lambda x: np.nanpercentile(x, 25))
    obs_percentile_75_ozone=df_CB6r5h_hourly_medians_species_conc.groupby('hour')['O3Initconc'].apply(lambda x: np.nanpercentile(x, 75))
    ...
    CB6r5h_percentile_25_ozone=df_CB6r5h_hourly_medians_species_conc.groupby('hour')['O3conc'].apply(lambda x: np.nanpercentile(x, 25))
    CB6r5h_percentile_75_ozone=df_CB6r5h_hourly_medians_species_conc.groupby('hour')['O3conc'].apply(lambda x: np.nanpercentile(x, 75))
    ...
    CRACMM_percentile_25_ozone=df_CRACMM_hourly_medians_species_conc.groupby('hour')['O3conc'].apply(lambda x: np.nanpercentile(x, 25))
    CRACMM_percentile_75_ozone=df_CRACMM_hourly_medians_species_conc.groupby('hour')['O3conc'].apply(lambda x: np.nanpercentile(x, 75))
    ...
    GEOSChem_percentile_25_ozone=df_GEOSChem_hourly_medians_species_conc.groupby('hour')['O3conc'].apply(lambda x: np.nanpercentile(x, 25))
    GEOSChem_percentile_75_ozone=df_GEOSChem_hourly_medians_species_conc.groupby('hour')['O3conc'].apply(lambda x: np.nanpercentile(x, 75))
