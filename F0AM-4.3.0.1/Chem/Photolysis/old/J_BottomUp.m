...
i = i+1; %CH3I in CB6r5h; full rxn: CH3I -> I + MEO2
Jnames{i} = 'Jv24';
...
i = i+1; %MI2 in CB6r5h; full rxn: CH2I2 -> I + I + Formaldehyde
Jnames{i} = 'Jv27';
CS{i} = 'Cross_Section_CH2I2_JPL-2010(2011)_298K_205-385nm(rec).txt';
QY{i} = 1;


i = i+1; %MIC in CB6r5h; full rxn: CH2ICl -> I + Cl + Formaldehyde
Jnames{i} = 'Jv28';
CS{i} = 'Cross_Section_CH2ICl_JPL-2010(2011)_298K_205-390nm(rec).txt';
QY{i} = 1;


i = i+1; %MIB in CB6r5h; full rxn: CH2IBr -> I + Br + Formaldehyde
Jnames{i} = 'Jv29';
