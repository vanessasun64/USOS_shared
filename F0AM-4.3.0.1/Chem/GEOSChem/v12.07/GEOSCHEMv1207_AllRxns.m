...
% N2O5 + HCl = ClNO2 + HNO3 : HET(ind_N2O5,2);
% N2O5 = ClNO2 + HNO3 : HET(ind_N2O5,3);
% N2O5 = 2.000HNO3 : HET(ind_N2O5,4);
% BrNO3 + H2O = HOBr + HNO3 : HET(ind_BrNO3,1);
% BrNO3 + HCl = BrCl + HNO3 : HET(ind_BrNO3,2);
% ClNO3 + H2O = HOCl + HNO3 : HET(ind_ClNO3,1);
% ClNO3 + HCl = Cl2 + HNO3 : HET(ind_ClNO3,2);
% ClNO3 + HBr = BrCl + HNO3 : HET(ind_ClNO3,3);
% ClNO3 + BrSALA = BrCl + HNO3 : HET(ind_ClNO3,4);
% ClNO3 + BrSALC = BrCl + HNO3 : HET(ind_ClNO3,5);
% HOCl + HCl = Cl2 + H2O : HET(ind_HOCl,1);
% HOCl + HBr = BrCl + H2O : HET(ind_HOCl,2);
% HOBr + HBr = Br2 + H2O : HET(ind_HOBr,1);
% HOBr + HCl = BrCl + H2O : HET(ind_HOBr,2);
% HOBr = BrCl + H2O : HET(ind_HOBr,3);
% HOBr + BrSALA = Br2 : HET(ind_HOBr,4);
% HOBr + BrSALC = Br2 : HET(ind_HOBr,5);
% HOBr = SO4H1 + HBr : HET(ind_HOBr,6);
% HOBr = SO4H2 + HBr : HET(ind_HOBr,7);
% HCl = O2 : HET(ind_HCl,1);
% HCl = O2 : HET(ind_HCl,2);
% O3 + HBr = HOBr : HET(ind_O3,1);
% O3 + BrSALA = HOBr : HET(ind_O3,2);
% O3 + BrSALC = HOBr : HET(ind_O3,3);
% HBr = BrSALA : HET(ind_HBr,1);
% HBr = BrSALC : HET(ind_HBr,2);
% HI = AERI : HET(ind_HI,1);
% HI = ISALA : HET(ind_HI,2);
% HI = ISALC : HET(ind_HI,3);
% HOI = ISALA : HET(ind_HOI,1);
% HOI = ISALC : HET(ind_HOI,2);
% I2O2 = 2.000AERI : HET(ind_I2O2,1);
% I2O2 = 2.000ISALA : HET(ind_I2O2,2);
% I2O2 = 2.000ISALC : HET(ind_I2O2,3);
% I2O3 = 2.000AERI : HET(ind_I2O3,1);
% I2O3 = 2.000ISALA : HET(ind_I2O3,2);
% I2O3 = 2.000ISALC : HET(ind_I2O3,3);
% I2O4 = 2.000AERI : HET(ind_I2O4,1);
% I2O4 = 2.000ISALA : HET(ind_I2O4,2);
% I2O4 = 2.000ISALC : HET(ind_I2O4,3);
% IONO = ISALA : HET(ind_IONO,1);
% IONO = ISALC : HET(ind_IONO,2);
% IONO2 = ISALA : HET(ind_IONO2,1);
% IONO2 = ISALC : HET(ind_IONO2,2);
% IONO = 0.850ICl + 0.150IBr + HNO2 : HET(ind_IONO,3);
% IONO2 = 0.850ICl + 0.150IBr + HNO3 : HET(ind_IONO2,3);
% HOI = 0.850ICl + 0.150IBr : HET(ind_HOI,3);
% GLYX = SOAGX : HET(ind_GLYX,1);
% MGLY = SOAMG : HET(ind_MGLY,1);
% IEPOXA = SOAIE : HET(ind_IEPOXA,1);
% IEPOXB = SOAIE : HET(ind_IEPOXB,1);
% IEPOXD = SOAIE : HET(ind_IEPOXD,1);
% IMAE = SOAME : HET(ind_IMAE,1);
% LVOC = LVOCOA : HET(ind_LVOC,1);
% ISN1OG = ISN1OA : HET(ind_ISN1OG,1);
% ISOPND = IONITA : HET(ind_ISOPND,1);
% ISOPNB = IONITA : HET(ind_ISOPNB,1);
% MACRN = IONITA : HET(ind_MACRN,1);
% MVKN = IONITA : HET(ind_MVKN,1);
% R4N2 = IONITA : HET(ind_R4N2,1);
% DHDN = IONITA : HET(ind_DHDN,1);
% MONITS = MONITA : HET(ind_MONITS,1);
% MONITU = MONITA : HET(ind_MONITU,1);
% HONIT = MONITA : HET(ind_HONIT,1);
...
'H2O2'; 'HAC'; 'HBr'; 'HC187'; 'HC5'; 'HC5OO'; 'HCFC123'; 'HCFC141b'; 'HCFC142b'; 'HCFC22'; ...
'HCl'; 'HCOOH'; 'HI'; 'HNO2'; 'HNO3'; 'HNO4'; 'HO2'; 'HOBr'; 'HOCl'; 'HOI'; ...
'HONIT'; 'HPALD'; 'HPC52O2'; 'I'; 'I2'; 'I2O2'; 'I2O3'; 'I2O4'; 'IAP'; 'IBr'; ...
'ICl'; 'IEPOXA'; 'IEPOXB'; 'IEPOXD'; 'IEPOXOO'; 'IMAE'; 'IMAO3'; 'INDIOL'; 'INO2'; 'INPN'; ...
'INO'; 'IO'; 'IONO'; 'IONO2'; 'IONITA'; 'IPMN'; 'IPRNO3'; 'ISALA'; 'ISALC'; 'ISN1'; ...
'ISN1OA'; 'ISN1OG'; 'ISNOOA'; 'ISNOOB'; 'ISNOHOO'; 'ISNP'; 'ISOP'; 'ISOPNB'; 'ISOPNBO2'; 'ISOPND'; ...
'ISOPNDO2'; 'KO2'; 'LBRO2H'; 'LBRO2N'; 'LIMO'; 'LIMO2'; 'LISOPOH'; 'LISOPNO3'; 'LTRO2H'; 'LTRO2N'; ...
'LVOC'; 'LVOCOA'; 'LXRO2H'; 'LXRO2N'; 'MACR'; 'MACRN'; 'MACRNO2'; 'MACROO'; 'MAN2'; 'MAOP'; ...
'MAOPO2'; 'MAP'; 'MBO'; 'MBOOO'; 'MCO3'; 'MEK'; 'MENO3'; 'MGLOO'; 'MGLY'; 'MGLYOO'; ...
'MO2'; 'MOBA'; 'MOBAOO'; 'MOH'; 'MONITA'; 'MONITS'; 'MONITU'; 'MP'; 'MPN'; 'MRO2'; ...
'MRP'; 'MSA'; 'MTPA'; 'MTPO'; 'MVK'; 'MVKN'; 'MVKOO'; 'N'; 'N2O'; 'N2O5'; ...
'NITs'; 'NIT'; 'NMAO3'; 'NO'; 'NO2'; 'NO3'; 'NPMN'; 'NPRNO3'; 'O'; 'O1D'; ...
'O3'; 'OClO'; 'OCS'; 'OH'; 'OIO'; 'OLND'; 'OLNN'; 'ONIT'; 'OTHRO2'; 'PAN'; ...
'PIO2'; 'PIP'; 'PMNN'; 'PMNO2'; 'PO2'; 'PP'; 'PPN'; 'PRN1'; 'PRPE'; 'PRPN'; ...
'PROPNN'; 'PYAC'; 'R4N1'; 'R4N2'; 'R4O2'; 'R4P'; 'RA3P'; 'RB3P'; 'RCHO'; 'RCO3'; ...
'RIO2'; 'RIPA'; 'RIPB'; 'RIPD'; 'ROH'; 'RP'; 'SO2'; 'SO4'; 'SO4H1'; 'SO4H2'; ...
'SOAGX'; 'SOAIE'; 'SOAME'; 'SOAMG'; 'TOLU'; 'TRO2'; 'VRO2'; 'VRP'; 'XYLE'; 'XRO2'; ...
'H2'; 'NH2'; 'NH3'; 'RCOOH'; };
...
k(:,i) = GCARR(T, 4.80E-11, 0.0E+00, 250.0);
...
k(:,i) = GCARR(T, 3.30E-12, 0.0E+00, 270.0);
...
k(:,i) = GCARR(T, 2.45E-12, 0.0E+00, -1775.0);
...
k(:,i) = GCARR(T, 4.10E-13, 0.0E+00, 750.0);
...
k(:,i) = GCARR(T, 5.50E-12, 0.0E+00, 125.0);
...
k(:,i) = GCARR(T, 1.80E-11, 0.0E+00, -390.0);
...
k(:,i) = GCARR(T, 4.63E-12, 0.0E+00, 350.0);
...
k(:,i) = GCARR(T, 1.40E-12, 0.0E+00, -1900.0);
...
k(:,i) = GCARR(T, 8.10E-12, 0.0E+00, 270.0);
...
k(:,i) = GCARR(T, 7.66E-12, 0.0E+00, -1020.0);
...
k(:,i) = GCARR(T, 2.60E-12, 0.0E+00, 365.0);
...
k(:,i) = GCARR(T, 2.70E-12, 0.0E+00, 350.0);
...
k(:,i) = GCARR(T, 9.10E-12, 0.0E+00, -405.0);
...
k(:,i) = GCARR(T, 2.80E-12, 0.0E+00, 300.0);
...
k(:,i) = GCARR(T, 4.07E+08, 0.0E+00, -7694.0);
Gstr{i,1} = 'RIO2'; 
...
k(:,i) = GCARR(T, 2.90E+07, 0.0E+00, -5297.0);
Gstr{i,1} = 'MRO2'; 
...
k(:,i) = GCARR(T, 2.30E-12, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 3.15E-13, 0.0E+00, -448.0);
...
k(:,i) = GCARR(T, 4.00E-12, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 6.70E-12, 0.0E+00, 340.0);
...
k(:,i) = GCARR(T, 5.20E-13, 0.0E+00, 980.0);
...
k(:,i) = GCARR(T, 2.60E-12, 0.0E+00, 380.0);
...
k(:,i) = GCARR(T, 2.06E-13, 0.0E+00, 1300.0);
...
k(:,i) = GCARR(T, 2.00E-13, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 4.15E-15, 0.0E+00, -1520.0);
...
k(:,i) = GCARR(T, 7.48E-12, 0.0E+00, 410.0);
...
k(:,i) = GCARR(T, 2.06E-13, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 1.20E-12, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 6.50E-15, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 5.92E-13, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 7.40E-13, 0.0E+00, 700.0);
...
k(:,i) = GCARR(T, 8.60E-13, 0.0E+00, 700.0);
...
k(:,i) = GCARR(T, 1.30E-12, 0.0E+00, -25.0);
...
k(:,i) = GCARR(T, 3.00E-13, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 8.00E-16, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 8.37E-14, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 7.50E-13, 0.0E+00, 500.0);
...
k(:,i) = GCARR(T, 1.30E-12, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 4.10E-14, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 2.70E-14, 0.0E+00, 0.0);
Gstr{i,1} = 'ETO2'; Gstr{i,2} = 'ETO2'; 
...
k(:,i) = GCARR(T, 4.30E-13, 0.0E+00, 1040.0);
...
k(:,i) = GCARR(T, 5.50E-15, 0.0E+00, -1880.0);
...
k(:,i) = GCARR(T, 2.90E-11, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 3.00E-11, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 3.36E-12, 0.0E+00, -1860.0);
...
k(:,i) = GCARR(T, 1.68E-12, 0.0E+00, 500.0);
...
k(:,i) = GCARR(T, 1.87E-13, 0.0E+00, 500.0);
Gstr{i,1} = 'MCO3'; Gstr{i,2} = 'A3O2'; 
...
k(:,i) = GCARR(T, 1.00E-14, 0.0E+00, -1970.0);
...
k(:,i) = GCARR(T, 8.5E-16, 0.0E+00, -1520.0);
...
k(:,i) = GCARR(T, 1.50E-15, 0.0E+00, -2110.0);
...
k(:,i) = GCARR(T, 3.50E-12, 0.0E+00, -450.0);
...
k(:,i) = GCARR(T, 3.40E-15, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 1.50E-12, 0.0E+00, -1815.0);
Gstr{i,1} = 'MACR'; Gstr{i,2} = 'NO3'; 
...
k(:,i) = GCARR(T, 1.90E-11, 0.0E+00, 390.0);
...
k(:,i) = GCARR(T, 5.18E-12, 0.0E+00, 200.0);
Gstr{i,1} = 'INPN'; Gstr{i,2} = 'OH'; 
...
k(:,i) = GCARR(T, 8.78E-12, 0.0E+00, 200.0);
...
i=i+1;
Rnames{i} = 'RP + OH = RCO3';
k(:,i) = GCARR(T, 6.13E-13, 0.0E+00, 200.0);
...
k(:,i) = GCARR(T, 6.13E-12, 0.0E+00, 200.0);
Gstr{i,1} = 'RIPA'; Gstr{i,2} = 'OH'; 
fRIPA(i)=fRIPA(i)-1; fOH(i)=fOH(i)-1; fRIO2(i)=fRIO2(i)+0.750; fHC5(i)=fHC5(i)+0.243; fOH(i)=fOH(i)+0.125; fLVOC(i)=fLVOC(i)+0.007; 

i=i+1;
Rnames{i} = 'RIPB + OH = 0.480RIO2 + 0.513HC5 + 0.260OH + 0.260H2O + 0.007LVOC';
k(:,i) = GCARR(T, 4.14E-12, 0.0E+00, 200.0);
Gstr{i,1} = 'RIPB'; Gstr{i,2} = 'OH'; 
fRIPB(i)=fRIPB(i)-1; fOH(i)=fOH(i)-1; fRIO2(i)=fRIO2(i)+0.480; fHC5(i)=fHC5(i)+0.513; fOH(i)=fOH(i)+0.260; fLVOC(i)=fLVOC(i)+0.007; 

i=i+1;
Rnames{i} = 'RIPD + OH = 0.250RIO2 + 0.743HC5 + 0.375OH + 0.375H2O + 0.007LVOC';
k(:,i) = GCARR(T, 5.11E-12, 0.0E+00, 200.0);
Gstr{i,1} = 'RIPD'; Gstr{i,2} = 'OH'; 
fRIPD(i)=fRIPD(i)-1; fOH(i)=fOH(i)-1; fRIO2(i)=fRIO2(i)+0.250; fHC5(i)=fHC5(i)+0.743; fOH(i)=fOH(i)+0.375; fLVOC(i)=fLVOC(i)+0.007; 

i=i+1;
Rnames{i} = 'RIPA + OH = 0.850OH + 0.578IEPOXA + 0.272IEPOXB + 0.143HC5OO + 0.007LVOC';
k(:,i) = GCARR(T, 1.70E-11, 0.0E+00, 390.0);
Gstr{i,1} = 'RIPA'; Gstr{i,2} = 'OH'; 
...
k(:,i) = GCARR(T, 2.97E-11, 0.0E+00, 390.0);
Gstr{i,1} = 'RIPB'; Gstr{i,2} = 'OH'; 
...
k(:,i) = GCARR(T, 2.92E-11, 0.0E+00, 390.0);
Gstr{i,1} = 'RIPD'; Gstr{i,2} = 'OH'; 
...
k(:,i) = GCARR(T, 5.31E-12, 0.0E+00, 200.0);
...
k(:,i) = GCARR(T, 3.60E-12, 0.0E+00, 380.0);
Gstr{i,1} = 'MAOP'; Gstr{i,2} = 'OH'; 
...
k(:,i) = GCARR(T, 1.40E-18, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 6.16E-15, 0.0E+00, -1814.0);
...
k(:,i) = GCARR(T, 2.00E-13, 0.0E+00, 500.0);
Gstr{i,1} = 'MCO3'; Gstr{i,2} = 'MO2'; 
...
k(:,i) = GCARR(T, 8.50E-13, 0.0E+00, -2450.0);
...
k(:,i) = GCARR(T, 3.70E-19, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 2.90E-17, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 1.20E-11, 0.0E+00, -280.0);
...
k(:,i) = GCARR(T, 1.90E-13, 0.0E+00, 530.0);
...
k(:,i) = GCARR(T, 1.40E-12, 0.0E+00, -2000.0);
Gstr{i,1} = 'H2O2'; Gstr{i,2} = 'O'; 
fH2O2(i)=fH2O2(i)-1; fO(i)=fO(i)-1; fOH(i)=fOH(i)+1; fHO2(i)=fHO2(i)+1; 

i=i+1;
Rnames{i} = 'H + O2 {+M} = HO2 {+M}';
k(:,i) = 4.4e-32.*exp(0./T).*(300./T).^(1.3).*M.*0.6.^(1./(1+(log10(5.8667e-22.*exp(0./T).*(300./T).^(1.5).*M)).*(log10(5.8667e-22.*exp(0./T).*(300./T).^(1.5).*M))))./(1+5.8667e-22.*exp(0./T).*(300./T).^(1.5).*M).*0.21.*M;
Gstr{i,1} = 'H'; 
fH(i)=fH(i)-1; fHO2(i)=fHO2(i)+1; 

i=i+1;
Rnames{i} = 'H + O3 = OH + O2';
k(:,i) = GCARR(T, 1.40E-10, 0.0E+00, -470.0);
Gstr{i,1} = 'H'; Gstr{i,2} = 'O3'; 
fH(i)=fH(i)-1; fO3(i)=fO3(i)-1; fOH(i)=fOH(i)+1; 

i=i+1;
Rnames{i} = 'H + HO2 = 2.000OH';
k(:,i) = GCARR(T, 7.20E-11, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 1.50E-10, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 2.70E-10, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 3.30E-10, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 1.80E-10, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 6.60E-10, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 1.02E-10, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 2.30E-10, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 1.40E-10, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 1.00E-10, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 2.60E-10, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 2.00E-10, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 2.32E-10, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 1.30E-10, 0.0E+00, -25.0);
...
k(:,i) = GCARR(T, 5.40E-11, 0.0E+00, -30.0);
...
k(:,i) = GCARR(T, 1.60E-10, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 4.69E-12, 0.0E+00, -1134.0);
...
k(:,i) = GCARR(T, 2.17E-11, 0.0E+00, -1130.0);
...
k(:,i) = GCARR(T, 1.24E-12, 0.0E+00, -1070.0);
...
k(:,i) = GCARR(T, 3.77E-12, 0.0E+00, -1011.0);
...
k(:,i) = GCARR(T, 5.5E-11, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 3.60E-12, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 8.40E-11, 0.0E+00, -2620.0);
...
k(:,i) = GCARR(T, 1.20E-11, 0.0E+00, 652.0);
...
k(:,i) = GCARR(T, 2.40E-12, 0.0E+00, 745.0);
...
k(:,i) = GCARR(T, 2.40E-12, 0.0E+00, 360.0);
...
k(:,i) = GCARR(T, 8.70E-14, 0.0E+00, 1650.0);
...
k(:,i) = GCARR(T, 4.75E-12, 0.0E+00, 200.0);
...
k(:,i) = GCARR(T, 4.40E-13, 0.0E+00, 380.0);
...
k(:,i) = GCARR(T, 8.79E-13, 0.0E+00, 380.0);
...
k(:,i) = GCARR(T, 2.52E-12, 0.0E+00, 410.0);
...
k(:,i) = GCARR(T, 2.79E-11, 0.0E+00, 380.0);
...
k(:,i) = GCARR(T, 2.00E-17, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 2.40E-12, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 7.00E-14, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 6.00E-18, 0.0E+00, 0.0).*H2O;
Gstr{i,1} = 'CH2OO'; 
fCH2OO(i)=fCH2OO(i)-1; fCH2O(i)=fCH2O(i)+1; fH2O2(i)=fH2O2(i)+1; 

i=i+1;
Rnames{i} = 'CH2OO + H2O = HCOOH';
k(:,i) = GCARR(T, 1.00E-17, 0.0E+00, 0.0).*H2O;
Gstr{i,1} = 'CH2OO'; 
...
k(:,i) = GCARR(T, 2.33E-12, 0.0E+00, -193.0);
...
k(:,i) = GCARR(T, 1.81E-12, 0.0E+00, 338.0);
...
k(:,i) = GCARR(T, 2.31E-11, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 1.21E-11, 0.0E+00, 440.0);
...
k(:,i) = GCARR(T, 3.56E-14, 0.0E+00, 708.0);
...
k(:,i) = GCARR(T, 7.40E-13, 0.0E+00, 765.0);
...
k(:,i) = GCARR(T, 5.00E-16, 0.0E+00, -530.0);
...
k(:,i) = GCARR(T, 8.33E-13, 0.0E+00, 490.0);
...
k(:,i) = GCARR(T, 4.20E-11, 0.0E+00, 401.0);
...
k(:,i) = GCARR(T, 2.95E-15, 0.0E+00, -783.0);
...
k(:,i) = GCARR(T, 1.22E-11, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 3.40E-12, 0.0E+00, 190.0);
...
k(:,i) = GCARR(T, 1.66E-13, 0.0E+00, 1300.0);
...
k(:,i) = GCARR(T, 1.60E-13, 0.0E+00, 708.0);
...
k(:,i) = GCARR(T, 9.68E-14, 0.0E+00, 708.0);
...
k(:,i) = GCARR(T, 8.85E-13, 0.0E+00, 765.0);
...
k(:,i) = GCARR(T, 5.37E-13, 0.0E+00, 765.0);
...
k(:,i) = GCARR(T, 7.00E-14, 0.0E+00, 1000.0);
...
k(:,i) = GCARR(T, 4.25E-14, 0.0E+00, 1000.0);
...
k(:,i) = GCARR(T, 2.96E-14, 0.0E+00, 1000.0);
...
k(:,i) = GCARR(T, 2.78E-04, 0.0E+00, 0.0);
Gstr{i,1} = 'IONITA'; 
...
k(:,i) = GCARR(T, 1.40E-11, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 5.10E-11, 0.0E+00, 0.0);
...
k(:,i) = GCARR(T, 2.70E-12, 0.0E+00, 360.0);
...
k(:,i) = GCARR(T, 2.05E-13, 0.0E+00, 1300.0);
...
k(:,i) = GCARR(T, 7.10E-13, 0.0E+00, 0.0);
...
i=i+1;
Rnames{i} = 'IPMN + hv = 0.600IMAO3 + 0.600NO2 + 0.400CO2 + 0.400CH2O + 0.400MCO3 + 0.400NO3';
k(:,i) = JPAN;
Gstr{i,1} = 'IPMN'; 
fIPMN(i)=fIPMN(i)-1; fIMAO3(i)=fIMAO3(i)+0.600; fNO2(i)=fNO2(i)+0.600; fCO2(i)=fCO2(i)+0.400; fCH2O(i)=fCH2O(i)+0.400; fMCO3(i)=fMCO3(i)+0.400; fNO3(i)=fNO3(i)+0.400; 
...
i=i+1;
Rnames{i} = 'DHDC + hv = MGLY + GLYX + 2.000OH';
k(:,i) = JHPALD;
Gstr{i,1} = 'DHDC'; 
fDHDC(i)=fDHDC(i)-1; fMGLY(i)=fMGLY(i)+1; fGLYX(i)=fGLYX(i)+1; fOH(i)=fOH(i)+2.000; 
