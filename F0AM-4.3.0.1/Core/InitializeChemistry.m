...
for j=3:length(ChemFiles)
    ...
    try
        ...
        if strcmp(ME.identifier,'MATLAB:badsubscript')
            msg = ['Total number of reactions or species in mechanism may exceed the initial guess of ',...
                ...
                'Or, you might just have a typo. In that case, you can try commenting out reactions to isolate the problem.'];
