...
pth_win="C:\Users\u1545774\Documents\GitHub\USOS_shared\F0AM-4.4.2\Runs\USOS_7_19_2024\Run30\GEOS-Chem\USOS_7_19_2024_run.mat"; 
load(pth_win)
%% 

% Set start/end date in MST time... 
foam_start=datetime('07/19/2024','InputFormat','MM/dd/yyyy');
foam_end=datetime('07/19/2024','InputFormat','MM/dd/yyyy');
yr=year(foam_start);mon=month(foam_start);dy=day(foam_start); 
t_start=datetime(yr,mon,dy,0,0,0);
t_end=datetime(yr,mon,dy,23,00,0);
